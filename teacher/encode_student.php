        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <!-- Form to add subject -->
                                            <form method="post" action="encoded.php?id=<?php echo $id; ?>">
                                            <div class="table-responsive">
                                                    ...
                                                    <table class="table">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            // Display schedules in table rows with checkboxes
                    ...
                    $sql = "SELECT * FROM encodedstudentsubjects INNER JOIN student ON encodedstudentsubjects.student_id = student.student_id WHERE student.isVerified = 2";
                                              ...
                                              <div class="modal-dialog">
                                                <div class="modal-content">
                                                  ...
                                                  <div class="modal-footer">
                                                    ...
                                                    <a href="delete.php?id='.$row['encoded_id'].'" class="btn btn-danger">Delete</a>
                                                  </div>
                                                </div>
                                              </div>
                                            </div>';
